        ...
        <b-col cols="8">
              <b-card                
                ...
                <b-media  vertical-align="center" class="mb-2">
                    ...
                    <b-card no-body>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                    sollicitudin. </b-card>
            ...
            <b-col cols="4">
                    <b-img rounded="circle" blank width="60" height="60" 
                    blank-color="#777" alt="img" class="m-1" />
